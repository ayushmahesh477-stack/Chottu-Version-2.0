...
REAL_WORLD_MENTIONS = [
    # === QUESTIONs that should ground (docs cover them) ===
    {
        ...
        "text": (
            "@ChottuAI does this work with vllm or "
    ...
    },
    {
        ...
        "author": "indie_hacker",
        "text": (
            "@ChottuAI can I run the orchestrator agent "
    ...
    },
    {
        ...
        "author": "macuser",
        "text": "@ChottuAI how do I install on macos with apple silicon?",
    },
    {
        "id": "3000000000000000004",
        "author": "longwinded_lou",
        "text": (
            "@ChottuAI how does the memory system handle "
    ...
    # === QUESTIONs that should defer (off-topic / unknowable) ===
    {
        ...
        "text": "@ChottuAI what's the weather in tokyo today?",
    },
    {
        "id": "3000000000000000006",
        "author": "specific_specs",
        "text": (
            "@ChottuAI what's the exact tokens-per-second "
    ...
    # === BUG / FEATURE / PRAISE / SPAM ===
    {
        ...
        "author": "devops_dan",
        "text": (
            "@ChottuAI getting a segfault on startup "
    ...
    },
    {
        ...
        "text": (
            "@ChottuAI any plans for SSO support? "
    ...
    },
    {
        ...
        "author": "convert_carl",
        "text": (
            "@ChottuAI switched from langchain last week, this is incredible"
        ),
    },
    {
        "id": "3000000000000000010",
        "author": "crypto_bro",
        "text": "@ChottuAI BUY $Chottu COIN guaranteed 10x gains link in bio",
    },
]
...
def main():
    ...
    j = Chottu(model=model, engine_key="ollama")

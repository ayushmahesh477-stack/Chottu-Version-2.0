#!/usr/bin/env python3
"""Index Chottu docs (README.md + docs/**/*.md) into a DenseMemory backend.
...
def build_index(
    ...
    *,
    ...
    dedupe: bool = True,
    # Empirical: on the actual Chottu docs the boilerplate that
    # crowds retrieval ("Chottu runs entirely on your hardware...")
...
def main() -> int:
    ...
    queries = args.query or [
        ...
        "what inference engines does Chottu support?",

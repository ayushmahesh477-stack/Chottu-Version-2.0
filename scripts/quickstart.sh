...
uv run maturin develop -m rust/crates/Chottu-python/Cargo.toml --quiet 2>/dev/null \
...
uv run Chottu serve --port 8000 &>/dev/null &
CLEANUP_PIDS+=($!)
sleep 3
...
echo ""
echo -e "${GREEN}${BOLD}  Chottu is running!${NC}"
echo ""

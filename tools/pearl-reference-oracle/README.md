# Pearl reference oracle (Chottu Phase 0 deliverable)
...
If it succeeds, this host can mine Pearl using the Chottu `cpu-pearl` provider
...
- When Pearl bumps `py-pearl-mining` API: re-run the smoke test against the
  new ref pinned in `Chottu/src/Chottu/mining/_constants.py`.

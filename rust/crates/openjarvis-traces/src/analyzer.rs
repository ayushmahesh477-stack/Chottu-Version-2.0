...
impl<'a> TraceAnalyzer<'a> {
    ...
    pub fn overall_stats(&self) -> Result<TraceStats, ChottuError> {
    ...
    pub fn stats_by_agent(&self) -> Result<HashMap<String, TraceStats>, ChottuError> {
        let traces = self.store.list_traces(10000, 0)?;
    ...
    pub fn stats_by_model(&self) -> Result<HashMap<String, TraceStats>, ChottuError> {
        let traces = self.store.list_traces(10000, 0)?;

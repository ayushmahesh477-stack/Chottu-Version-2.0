...
use Chottu_core::error::ChottuError;
use Chottu_core::{EventBus, EventType, GenerateResult, Message};
use Chottu_engine::traits::{InferenceEngine, TokenStream};
    ...
    fn handle_findings(
        ...
        match self.mode {
            ...
            RedactionMode::Block => {
                ...
                Err(ChottuError::Security(
                    Chottu_core::error::SecurityError::Blocked(format!(
...
mod tests {
    ...
    fn test_guardrails_block_mode() {
        ...
        let err = guardrails
            .generate(&[Message::user("Hi")], "mock", 0.7, 100, None)
            .unwrap_err();
        assert!(matches!(err, ChottuError::Security(_)));
    }
}

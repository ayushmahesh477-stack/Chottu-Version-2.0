...
impl AuditLogger {
    ...
    pub fn log(&self, event: &SecurityEvent) -> Result<(), ChottuError> {
    ...
    pub fn verify_chain(&self) -> Result<(bool, Option<i64>), ChottuError> {
        let mut stmt = self
            .conn
            .prepare(
    ...
    pub fn query(
        ...
        since: Option<f64>,
        limit: usize,
    ) -> Result<Vec<SecurityEvent>, ChottuError> {

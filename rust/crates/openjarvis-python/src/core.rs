...
impl PyMessage {
    pub fn to_core(&self) -> Chottu_core::Message {
        let role = match self.role.as_str() {
            "system" => Chottu_core::Role::System,
            "assistant" => Chottu_core::Role::Assistant,
            "tool" => Chottu_core::Role::Tool,
            _ => Chottu_core::Role::User,
        };
        Chottu_core::Message {
            role,
...
#[pyclass(name = "Config")]
pub struct PyConfig {
    pub inner: Chottu_core::ChottuConfig,
}
...
impl PyConfig {
    ...
    fn new() -> Self {
        Self {
            inner: Chottu_core::ChottuConfig::default(),
        }
    }
...
pub struct PyEventBus {
    pub inner: std::sync::Arc<Chottu_core::EventBus>,
}
...
impl PyEventBus {
    ...
    fn new() -> Self {
        Self {
            inner: std::sync::Arc::new(Chottu_core::EventBus::new(true)),
        }
    }

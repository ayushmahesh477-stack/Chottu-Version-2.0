...
use Chottu_core::{GenerateResult, Message, Role};
use serde_json::Value;
use std::pin::Pin;
use tokio_stream::Stream;

pub type StreamItem = Result<String, Chottu_core::ChottuError>;
...
pub trait InferenceEngine: Send + Sync {
    ...
    fn generate(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<GenerateResult, Chottu_core::ChottuError>;
    ...
    async fn stream(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<TokenStream, Chottu_core::ChottuError>;

    fn list_models(&self) -> Result<Vec<String>, Chottu_core::ChottuError>;
...
mod tests {
    use super::*;
    use Chottu_core::{Message, ToolCall};

# Contributing to Chottu

Thank you for your interest in contributing to Chottu! This guide covers everything you need to know — from why to contribute, to how to submit your first pull request.

---

## Why Contribute?

Contributing to Chottu isn't just about code — it's about building the future of on-device AI together. Here's what you get:

### Paper Acknowledgment

All contributors with merged pull requests will be acknowledged as contributors on the Chottu paper release.
...
See the [Savings Leaderboard](https://Chottu.github.io/Chottu/leaderboard/) for details.
...
Look for issues labeled [`good-first-issue`](https://github.com/Chottu/Chottu/labels/good-first-issue).
...
1. Browse the [Roadmap](https://Chottu.github.io/Chottu/development/roadmap/) for an item that interests you
2. Check if a [GitHub issue](https://github.com/Chottu/Chottu/issues) already exists for it — if not, [open one](https://github.com/Chottu/Chottu/issues/new/choose) describing what you'd like to work on
...
Use the appropriate [issue template](https://github.com/Chottu/Chottu/issues/new/choose):
...
Chottu is built on five composable primitives. Here's where you can contribute:
...
- Open a [Discussion](https://github.com/Chottu/Chottu/discussions) for questions and help
- Check the [documentation](https://Chottu.github.io/Chottu/) for guides and API reference

...
See how the Chottu community saves money, energy, and compute by running AI locally instead of using cloud providers.

!!! info "Win a Mac Mini!"
    Opt in to share your savings from the Chottu browser app or desktop app for a chance to win a Mac Mini. Your data is fully anonymous — no email, no IP, no hardware info.

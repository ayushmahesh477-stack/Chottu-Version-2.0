---
title: Downloads
description: Download the Chottu desktop app, browser app, CLI, or Python SDK
---
...
!!! info "Backend required"
    ...
    ```bash
    git clone https://github.com/Chottu/Chottu.git && cd Chottu
...
|----------|----------|-------|
| macOS (Universal) | [:material-download: **Chottu.dmg**](https://github.com/Chottu/Chottu/releases/download/desktop-v1.0.2/Chottu_1.0.1_universal.dmg) | Apple Silicon + Intel |
| Windows (64-bit) | [:material-download: **Chottu-setup.exe**](https://github.com/Chottu/Chottu/releases/download/desktop-v1.0.2/Chottu_1.0.1_x64-setup.exe) | Windows 10+ |
| Linux (DEB) | [:material-download: **Chottu.deb**](https://github.com/Chottu/Chottu/releases/download/desktop-v1.0.2/Chottu_1.0.1_amd64.deb) | Ubuntu, Debian |
| Linux (RPM) | [:material-download: **Chottu.rpm**](https://github.com/Chottu/Chottu/releases/download/desktop-v1.0.2/Chottu-1.0.1-1.x86_64.rpm) | Fedora, RHEL |
| Linux (AppImage) | [:material-download: **Chottu.AppImage**](https://github.com/Chottu/Chottu/releases/download/desktop-v1.0.2/Chottu_1.0.1_amd64.AppImage) | Any distro |
...
by Apple. If you see **"Chottu is damaged and can't be opened"**, run this in

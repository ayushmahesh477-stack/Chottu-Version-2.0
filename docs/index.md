...
Chottu is a research framework for composable, on-device AI systems.
...
=== "Desktop App"
    ...
    The desktop app is a native window for the Chottu UI.
    ...
    **Step 2.** Download and open the desktop app:
    ...
    [Download for macOS](https://github.com/Chottu/Chottu/releases/download/desktop-v1.0.2/Chottu_1.0.1_universal.dmg){ .md-button .md-button--primary }

    Also available for [Windows](https://github.com/Chottu/Chottu/releases/download/desktop-v1.0.2/Chottu_1.0.1_x64-setup.exe), [Linux (DEB)](https://github.com/Chottu/Chottu/releases/download/desktop-v1.0.2/Chottu_1.0.1_amd64.deb), and [Linux (RPM)](https://github.com/Chottu/Chottu/releases/download/desktop-v1.0.2/Chottu-1.0.1-1.x86_64.rpm). See the [Downloads](downloads.md) page for details.

    The app connects to `http://localhost:8000` automatically.

    !!! warning "macOS first launch"

        Run `xattr -cr /Applications/Chottu.app` if the app shows as "damaged".
...
Chottu is built around five composable layers. Each has a clean interface and can be swapped independently.

1. **Intelligence** — Pick a model, or let Chottu pick one for your hardware. Manages the full catalog of local models across providers.
...
-   **OpenAI-Compatible API**
    ...
    `Chottu serve` starts a FastAPI server with SSE streaming. Drop-in replacement for OpenAI clients.
...
-   **[Getting Started](getting-started/installation.md)**
    ...
    Install Chottu, configure your first engine, and run your first query.
...
-   **[API Reference](api-reference/Chottu/index.md)**
...
Read the [blog post](https://scalingintelligence.stanford.edu/blogs/Chottu/) for the full research motivation, architecture details, and experimental results.

## Citation

```bibtex
@misc{saadfalcon2026Chottupersonalaipersonal,
...
Follow [@ChottuAI](https://x.com/ChottuAI) on X for updates.

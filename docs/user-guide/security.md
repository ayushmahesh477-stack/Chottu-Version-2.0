...
Chottu includes a security layer that scans prompts and model outputs for secrets, personally identifiable information (PII), and sensitive file paths. The system is designed to be composable: scanners run as a pipeline, and the `GuardrailsEngine` wrapper drops in front of any inference backend without changing how the rest of your code works.
...
=== "Warn mode (default)"
    ...
    from Chottu.security.guardrails import GuardrailsEngine
    from Chottu.security.types import RedactionMode
...
=== "Block mode"
    ...
    from Chottu.engine.ollama import OllamaEngine
    from Chottu.security.guardrails import GuardrailsEngine, SecurityBlockError
    from Chottu.security.types import RedactionMode
    from Chottu.core.types import Message, Role
...
from Chottu.security.guardrails import GuardrailsEngine
from Chottu.security.scanner import SecretScanner
from Chottu.security.types import RedactionMode
...
from Chottu.security.scanner import PIIScanner
...
from Chottu.security.file_policy import is_sensitive_file, filter_sensitive_paths
...
from Chottu.security.audit import AuditLogger
from Chottu.security.guardrails import GuardrailsEngine
from Chottu.security.types import RedactionMode
from Chottu.engine.ollama import OllamaEngine
...
audit = AuditLogger(db_path="~/.Chottu/audit.db", bus=bus)
...
import time
from Chottu.security.audit import AuditLogger
from Chottu.security.types import SecurityEvent, SecurityEventType
...
audit = AuditLogger(db_path="~/.Chottu/audit.db")
...
Security settings live in the `[security]` section of `~/.Chottu/config.toml`.
...
secret_scanner = true
pii_scanner = true
audit_log_path = "~/.Chottu/audit.db"
...
| `audit_log_path` | `str` | `~/.Chottu/audit.db` | Path to the SQLite audit log |
...
import re
from Chottu.security._stubs import BaseScanner
from Chottu.security.types import ScanFinding, ScanResult, ThreatLevel
...
- [API Reference: Security](../api-reference/Chottu/security/index.md) — full class and function signatures

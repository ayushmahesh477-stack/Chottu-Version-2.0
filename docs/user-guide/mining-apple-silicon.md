...
README. Then write Chottu' mining config:
...
```bash
Chottu mine doctor        # capability matrix
Chottu mine start         # launch gateway + miner-loop subprocesses
Chottu mine status        # check sidecar + gateway metrics
Chottu mine logs -n 120   # print recent logs
Chottu mine stop          # stop mining subprocesses
```

...
Serves the installers at::
    ...
    https://Chottu.github.io/Chottu/install.sh   (Linux / macOS / WSL2)
    https://Chottu.github.io/Chottu/install.ps1  (native Windows)

so users have an HTTPS-valid, project-controlled install URL that does not
depend on the externally-hosted ``Chottu.ai`` domain — whose TLS config

...
```python
from Chottu.intelligence import merge_discovered_models
...
The following names are still importable from `Chottu.intelligence` via shim modules, but their canonical locations have moved:

...
The default path is `~/.Chottu/audit.db`, configurable via `security.audit_log_path` in `config.toml`.
...
- [API Reference: Security](../api-reference/Chottu/security/index.md) — complete class and function signatures

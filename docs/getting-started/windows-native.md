...
- Python 3.10 – 3.13 (Python 3.14 has no numpy Windows wheels yet —
  see [#432](https://github.com/Chottu/Chottu/issues/432)).
- `git` on PATH.
...
4. Install `uv` if absent (via the official `astral.sh/uv` PowerShell
   installer).
5. Clone the repo to `%LOCALAPPDATA%\Chottu\src`.
...
See [`deploy/windows/README.md`](https://github.com/Chottu/Chottu/blob/main/deploy/windows/README.md)

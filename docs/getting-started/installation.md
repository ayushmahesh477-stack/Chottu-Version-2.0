---
title: Installation
description: Get Chottu running — browser app, desktop app, CLI, or Python SDK
search:
  boost: 3
---
...
Chottu runs entirely on your hardware. Choose the interface that fits your workflow.
...
=== "Step 1: Clone and install"
    ...
    uv run maturin develop -m rust/crates/Chottu-python/Cargo.toml
...
The desktop app is a native window for the Chottu chat UI. All inference and backend
...
| Platform | Download |
|----------|----------|
| macOS (Universal) | [:material-download: **Chottu.dmg**](https://github.com/Chottu/Chottu/releases/download/desktop-v1.0.2/Chottu_1.0.1_universal.dmg) |
| Windows (64-bit) | [:material-download: **Chottu-setup.exe**](https://github.com/Chottu/Chottu/releases/download/desktop-v1.0.2/Chottu_1.0.1_x64-setup.exe) |
| Linux (DEB) | [:material-download: **Chottu.deb**](https://github.com/Chottu/Chottu/releases/download/desktop-v1.0.2/Chottu_1.0.1_amd64.deb) |
| Linux (RPM) | [:material-download: **Chottu.rpm**](https://github.com/Chottu/Chottu/releases/download/desktop-v1.0.2/Chottu-1.0.1-1.x86_64.rpm) |
| Linux (AppImage) | [:material-download: **Chottu.AppImage**](https://github.com/Chottu/Chottu/releases/download/desktop-v1.0.2/Chottu_1.0.1_amd64.AppImage) |
...
!!! warning "macOS: \"app is damaged\""
    ...
    ```bash
    xattr -cr /Applications/Chottu.app
    ```
    This is normal for open-source apps distributed outside the App Store.

!!! tip "All releases"
    Browse all versions on the [GitHub Releases](https://github.com/Chottu/Chottu/releases) page.
...
The command-line interface is the fastest way to interact with Chottu
...
Chottu ask --agent orchestrator --tools calculator "What is 137 * 42?"
...
For programmatic access, the `Chottu` class provides a high-level sync API.
...
```python
from Chottu import SystemBuilder
...
Chottu uses optional extras to keep the base installation lightweight.
...
!!! note "Ollama, vLLM, and llama.cpp are HTTP-based"
    These engines have no additional Python dependencies — Chottu communicates over HTTP. You still need the engine software running on your machine.
...
| Extra | Install Command | Description |
|-------|----------------|-------------|
| `server` | `uv sync --extra server` | OpenAI-compatible API server (`Chottu serve`) |
...
Chottu requires at least one inference backend. Choose the one that matches your hardware.

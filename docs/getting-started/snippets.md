---
title: Code Snippets
description: Copy-paste patterns for common Chottu tasks
---

# Code Snippets

Ready-to-use patterns for the most common Chottu tasks. Each snippet is self-contained and copy-pasteable.
...
Run with: `Chottu compose run research_assistant "quantum computing advances"`

## API Server (1 command)

```bash
Chottu serve --port 8000 --engine ollama --model qwen3:8b
```
...
```bash
docker build -t Chottu .
docker run -p 8000:8000 Chottu serve --host 0.0.0.0
```

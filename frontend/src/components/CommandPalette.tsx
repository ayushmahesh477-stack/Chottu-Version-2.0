...
const CLOUD_PROVIDERS: CloudProvider[] = [
  ...
  },
  {
    ...
    storageKey: 'Chottu-anthropic-key',
    models: [
  ...
  },
  {
    ...
    storageKey: 'Chottu-openrouter-key',
    models: [
      ...
      >
        ...
        >
          {tab === 'installed' ? (
            ...
            <span>API keys are stored locally and never sent to Chottu servers</span>
          )}
        </div>
      </div>
    </div>

...
const OPTIN_KEY = 'Chottu-desktop-optin';
const OPTIN_NAME_KEY = 'Chottu-desktop-display-name';
const OPTIN_EMAIL_KEY = 'Chottu-desktop-email';
const OPTIN_ANONID_KEY = 'Chottu-desktop-anon-id';
    ...
    <div style={styles.container}>
      ...
      {showOptIn ? (
        ...
        <div style={{ marginBottom: 16, display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <a
            href="https://Chottu.github.io/Chottu/leaderboard"
            target="_blank"

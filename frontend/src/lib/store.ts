...
const CONVERSATIONS_KEY = 'Chottu-conversations';
const SETTINGS_KEY = 'Chottu-settings';
const OPTIN_KEY = 'Chottu-optin';
const OPTIN_NAME_KEY = 'Chottu-display-name';
const OPTIN_EMAIL_KEY = 'Chottu-email';
const OPTIN_ANONID_KEY = 'Chottu-anon-id';
const OPTIN_SEEN_KEY = 'Chottu-optin-seen';
...
interface Settings {
  theme: ThemeMode;
  apiUrl: string;
  // Local server API key (Chottu_API_KEY). Sent as a Bearer token on
  // /v1 + /api requests so a key-protected `Chottu serve` doesn't 401 the

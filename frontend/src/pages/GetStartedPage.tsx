...
const GITHUB_BASE =
  'https://github.com/Chottu/Chottu/releases/latest/download';
    ...
    <>
      ...
      <div className="flex flex-col gap-3 mb-10">
        <Section icon={Terminal} title="Command Line (macOS / Linux)" defaultOpen>
          ...
          <CodeBlock code={"git clone https://github.com/Chottu/Chottu.git\ncd Chottu\nuv sync"} />
          <p className="text-xs mt-1" style={{ color: 'var(--color-text-secondary)' }}>
            Then get started:
          </p>
          <CodeBlock code={"Chottu init\nChottu doctor\nChottu chat"} />
        </Section>

...
Single source of truth for every event name and property the Chottu
...
see :mod:`Chottu.analytics.redaction` for the value-level filters.
...
_SPECS: tuple[EventSpec, ...] = (
    ...
    EventSpec(
        ...
        description="`Chottu init` finished and config.toml was written.",
        properties={

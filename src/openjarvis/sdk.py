"""High-level Python SDK for Chottu."""
...
from Chottu.system import ChottuSystem, SystemBuilder
from Chottu.telemetry.instrumented_engine import InstrumentedEngine
...
class MemoryHandle:
    ...
    def __init__(self, config: ChottuConfig) -> None:
        self._config = config
    ...
    def _get_backend(self) -> Any:
        ...
        if not MemoryRegistry.contains(key):
            ...
            try:
                from Chottu.tools.storage.sqlite import SQLiteMemory  # noqa: F401
            except ImportError:
                pass
    ...
    def index(
        ...
        *,
        ...
        from Chottu.tools.storage.chunking import ChunkConfig
        from Chottu.tools.storage.ingest import ingest_path
...
class Chottu:
    ...
    @property
    def config(self) -> ChottuConfig:
        """Return the active configuration."""
        return self._config

    @property
    def version(self) -> str:
        """Return the Chottu version string."""
        return Chottu.__version__
    ...
    def _ensure_engine(self) -> None:
        ...
        try:
            import Chottu.engine  # noqa: F401
        except ImportError:
            pass
    ...
    def _run_agent(
        ...
        *,
        ...
        import Chottu.agents  # noqa: F401
        from Chottu.agents._stubs import AgentContext
        ...
        if tools:
            ...
            from Chottu.cli.ask import _build_tools
        ...
        if agent_name == "morning_digest" and hasattr(self._config, "digest"):
            ...
            from Chottu.tools.digest_collect import DigestCollectTool
            from Chottu.tools.text_to_speech import TextToSpeechTool
        ...
        if context and self._config.agent.context_from_memory:
            try:
                from Chottu.cli.ask import _get_memory_backend
                from Chottu.tools.storage.context import (
                    ContextConfig,
                    inject_context,
                )
...
__all__ = ["Chottu", "ChottuSystem", "MemoryHandle", "SystemBuilder"]

...
if TYPE_CHECKING:
    from Chottu.evals.core.types import EvalSuiteConfig
    from Chottu.operators.types import OperatorManifest
    from Chottu.recipes.loader import Recipe
...
def recipe_to_eval_suite(
    ...
    backend = recipe.eval_backend or ("Chottu-agent" if has_agent else "Chottu-direct")

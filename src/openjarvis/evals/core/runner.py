...
from Chottu.evals.core.backend import InferenceBackend
from Chottu.evals.core.dataset import DatasetProvider
from Chottu.evals.core.export import _hardware_info_dict
from Chottu.evals.core.scorer import Scorer
from Chottu.evals.core.tracker import ResultTracker
...
try:
    from Chottu.telemetry.efficiency import compute_efficiency
except ImportError:  # pragma: no cover
    compute_efficiency = None  # type: ignore[assignment]

try:
    from Chottu.telemetry.efficiency import estimate_model_flops_per_token
except ImportError:  # pragma: no cover
...
class EvalRunner:
    ...
    def run(
        ...
        from Chottu.evals.core.dataset import DatasetProvider as _DP
    ...
    def _process_one(self, record: EvalRecord) -> EvalResult:
        ...
        def _backend_error_result(full: dict, message: str) -> EvalResult:
            ...
            return EvalResult(
                ...
                framework=full.get(
                    "framework",
                    getattr(self._backend, "framework_name", "Chottu"),
                ),
        ...
        try:
            ...
            return EvalResult(
                ...
                framework=full.get("framework", "Chottu"),
            ...
            return EvalResult(
                ...
                model_answer="",
                error=str(exc),
                framework=getattr(self._backend, "framework_name", "Chottu"),

...
class TestChottuDirectBackend:
    ...
    def test_construction_default(self, mock_builder_cls):
        ...
        backend = ChottuDirectBackend()
        assert backend.backend_id == "Chottu-direct"
    ...
    def test_construction_with_engine_key(self, mock_builder_cls):
        ...
        ChottuDirectBackend(engine_key="cloud")
...
class TestChottuAgentBackend:
    ...
    def test_construction(self, mock_builder_cls):
        ...
        backend = ChottuAgentBackend(
            engine_key="cloud",
            agent_name="orchestrator",
            tools=["calculator", "think"],
        )
        assert backend.backend_id == "Chottu-agent"
        mock_builder.engine.assert_called_with("cloud")
    ...
    def test_generate_full(self, mock_builder_cls):
        ...
        backend = ChottuAgentBackend(agent_name="orchestrator")

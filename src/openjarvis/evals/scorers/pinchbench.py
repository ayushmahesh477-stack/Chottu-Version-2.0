...
Provides transcript translation (Chottu events → PinchBench format),
...
from Chottu.evals.core.event_recorder import EventType
from Chottu.evals.core.scorer import LLMJudgeScorer
from Chottu.evals.core.types import EvalRecord

LOGGER = logging.getLogger(__name__)

# ---------------------------------------------------------------------------
# Tool name mapping: Chottu name → PinchBench-expected name
# ---------------------------------------------------------------------------
...
def _tool_results_to_transcript(
    ...
    """Build transcript from ChottuAgentBackend tool_results list."""
    transcript: List[Dict[str, Any]] = []

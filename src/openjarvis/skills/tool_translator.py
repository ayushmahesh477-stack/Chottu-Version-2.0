"""ToolTranslator — translate external tool names to Chottu equivalents.

External skill libraries (Hermes Agent, OpenClaw) reference tools by Claude
Code's standard tool names (Bash, Read, Write, etc.).  Chottu uses
...
# ---------------------------------------------------------------------------
# Translation table — external name → Chottu name
# ---------------------------------------------------------------------------

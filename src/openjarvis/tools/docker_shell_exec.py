...
:func:`Chottu.tools.docker_shell_exec.set_active_container`). When no
container is active the tool refuses to run — it is explicitly not a
host-shell alternative.

The expected lifecycle is:

    from Chottu.tools.docker_shell_exec import set_active_container
...
from Chottu.tools._stubs import BaseTool, ToolResult, ToolSpec

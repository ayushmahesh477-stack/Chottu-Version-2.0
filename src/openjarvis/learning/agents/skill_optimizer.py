...
``~/.Chottu/learning/skills/<skill-name>/optimized.toml``.
...
from Chottu.core.types import Trace, TraceStep
...
class SkillOptimizer:
    ...
    def _run_dspy(
        ...
        """
        from Chottu.core.config import DSPyOptimizerConfig
        from Chottu.learning.agents.dspy_optimizer import DSPyAgentOptimizer
    ...
    def _run_gepa(
        ...
        from Chottu.learning.agents.gepa_optimizer import GEPAAgentOptimizer

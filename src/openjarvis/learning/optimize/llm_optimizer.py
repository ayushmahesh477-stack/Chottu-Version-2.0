"""LLM-based optimizer for Chottu configuration tuning.

Uses a cloud LLM to propose optimal Chottu configs, inspired by DSPy's
...
from Chottu.core.types import Trace
...
class LLMOptimizer:
    """Uses a cloud LLM to propose optimal Chottu configs.
    ...
    def _build_initial_prompt(self) -> str:
        ...
        lines: List[str] = []
        lines.append("You are optimizing an Chottu AI system configuration.")
        lines.append("")
    ...
    def _build_analyze_prompt(
        ...
        lines: List[str] = []
        lines.append("Analyze this Chottu evaluation result.")
        lines.append("")

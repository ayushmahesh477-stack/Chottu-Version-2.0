...
Adapted from IPW's ``environment.py``.  Uses Chottu's
:class:`~Chottu.tools._stubs.ToolExecutor` for real tool dispatch
...
class OrchestratorEnvironment:
    """RL environment that executes tools via Chottu ``ToolExecutor``.

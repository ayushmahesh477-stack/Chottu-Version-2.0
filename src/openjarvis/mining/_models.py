...
from Chottu.mining._constants import DEFAULT_PEARL_MODEL
...
class PearlModelSpec:
    """Chottu support metadata for a Pearl-compatible model."""
...
PEARL_MODEL_SPECS: tuple[PearlModelSpec, ...] = (
    ...
    PearlModelSpec(
        ...
        notes=(
            ...
            "Chottu before mining is enabled by default."
        ),
    ),
    PearlModelSpec(

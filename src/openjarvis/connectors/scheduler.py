...
from Chottu.connectors._stubs import BaseConnector
...
class SyncScheduler:
    ...
    ----------
    sync_engine:
        The :class:`~Chottu.connectors.sync_engine.SyncEngine` used to
    ...
    def add(self, connector: BaseConnector) -> None:
        ...
        ----------
        connector:
            Any :class:`~Chottu.connectors._stubs.BaseConnector` instance.

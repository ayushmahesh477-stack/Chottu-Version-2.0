...
from Chottu.connectors._stubs import Attachment, Document
from Chottu.connectors.chunker import SemanticChunker
...
if TYPE_CHECKING:
    from Chottu.connectors.attachment_store import AttachmentStore

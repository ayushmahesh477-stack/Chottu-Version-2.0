...
Renamed from ``ReActAgent`` to clarify this is Chottu's native
...
from Chottu.agents.prompt_loader import (
...
from Chottu.core.types import Message, Role, ToolCall, ToolResult, _message_to_dict
from Chottu.engine._stubs import InferenceEngine
from Chottu.tools._stubs import BaseTool, build_tool_descriptions
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        if self._skill_few_shot_examples:
            ...
            skill_examples_block = ""
        # Respect $Chottu_HOME override for the base template (M2+ work).
        prompt_template = (

...
# src/Chottu/agents/hybrid/registry/<method>.toml
...
#
# Then run:
#   python -m Chottu.agents.hybrid.runner --cell <printed name>
...
echo "Run with: python -m Chottu.agents.hybrid.runner --cell ${name}"

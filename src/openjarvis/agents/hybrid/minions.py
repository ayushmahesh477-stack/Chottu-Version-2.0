...
from Chottu.agents.hybrid._openai_retry import (
    patch_openai_globally as _patch_openai_globally,
)
from Chottu.agents.hybrid._prices import NO_TEMP_PREFIXES
...
def _prefetch_context(
    ...
    try:
        ...
        from Chottu.agents.hybrid._prices import cost as _cost_usd
        out.update(
            text=text,
            tokens=p + c,

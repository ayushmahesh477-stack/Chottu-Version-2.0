...
Why not just use Chottu's :class:`InferenceEngine` for both? Two reasons:
...
from Chottu.agents.hybrid._openai_retry import patch_openai_globally
...
class LocalCloudAgent(BaseAgent):
    ...
    def _call_openrouter(
        ...
        *,
        ...
        pass the Chottu-engine-style ``"openrouter/<provider>/<model>"``
        prefix (see ``src/Chottu/engine/cloud.py``) — we strip it here.

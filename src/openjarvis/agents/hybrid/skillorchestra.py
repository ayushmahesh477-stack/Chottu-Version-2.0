...
scope for the Chottu port (and was out of scope in the hybrid harness).
...
from Chottu.agents.hybrid._base import LocalCloudAgent
from Chottu.agents.hybrid._prices import supports_temperature

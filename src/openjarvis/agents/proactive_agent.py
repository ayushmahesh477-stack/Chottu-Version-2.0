...
called from your app startup:
    ...
    from Chottu.agents.proactive_agent import register_cron
...
from Chottu.tools.approval_store import (
...
from Chottu.tools.proactive_tools import get_store
...
def _build_notification_channel(channel_spec: str) -> Optional[Any]:
    ...
    if channel_type == "imessage":
        from Chottu.channels._stubs import (
            BaseChannel,
            ChannelStatus,
        )
        ...
        class _IMessageShim(BaseChannel):
            ...
            def send(
                ...
                from Chottu.channels.imessage_daemon import send_imessage
...
class ProactiveAgent(ToolUsingAgent):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        from Chottu.tools.channel_tools import ChannelSendTool
        from Chottu.tools.digest_collect import DigestCollectTool
        from Chottu.tools.proactive_tools import (
            CheckPermissionTool,
    ...
    def _build_system_prompt(self) -> str:
        user_md = _load_md_file(Path.home() / ".Chottu" / "USER.md")
        memory_md = _load_md_file(Path.home() / ".Chottu" / "MEMORY.md")
        now = datetime.now()
        context_block = ""

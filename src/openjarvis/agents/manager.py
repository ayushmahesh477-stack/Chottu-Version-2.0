...
class AgentManager:
    ...
    def __init__(self, db_path: str, *, clear_stale_running: bool = False) -> None:
        ...
        # commands (`Chottu agents list/info/...`) and the SystemBuilder path
    ...
    def create_agent(
        ...
        from Chottu.agents.executor import _AGENT_TICK_DEFAULT_MODEL
    ...
    def list_templates() -> List[Dict[str, Any]]:
        ...
        # Built-in templates
        try:
            tpl_dir = importlib.resources.files("Chottu.agents") / "templates"
        ...
        # User templates
        user_dir = Path("~/.Chottu/templates").expanduser()
        if user_dir.is_dir():

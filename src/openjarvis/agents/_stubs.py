...
from Chottu.core.types import Conversation, Message, Role, ToolResult
...
class BaseAgent(ABC):
    ...
    def _apply_persona(self, system_prompt: Optional[str]) -> Optional[str]:
        ...
        ``Chottu ask`` (#376) by *appending* persona to — never replacing —
...
class ToolUsingAgent(BaseAgent):
    ...
    def __init__(
        ...
        *,
        ...
        try:
            from Chottu.agents.loop_guard import LoopGuard, LoopGuardConfig

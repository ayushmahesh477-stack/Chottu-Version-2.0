...
Routes incoming :class:`~Chottu.channels._stubs.ChannelMessage` objects
...
from Chottu.channels._stubs import BaseChannel, ChannelMessage
...
_ESCALATION_TEMPLATE = "{preview}...\n\n---\nFull report ready — open in Chottu:\nChottu://research/{session_id}"
...
class ChannelAgent:
    ...
    agent:
        ...
        method (typically a :class:`~Chottu.agents._stubs.BaseAgent`
        subclass).
    max_workers:

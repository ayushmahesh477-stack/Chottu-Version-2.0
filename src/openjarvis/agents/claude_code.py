...
_OUTPUT_START = "---Chottu_OUTPUT_START---"
_OUTPUT_END = "---Chottu_OUTPUT_END---"
...
class ClaudeCodeAgent(BaseAgent):
    ...
    def _ensure_runner(self) -> Path:
        """Copy the bundled runner to ``~/.Chottu/claude_code_runner/``
        ...
        dest = Path.home() / ".Chottu" / "claude_code_runner"

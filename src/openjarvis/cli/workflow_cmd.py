"""``Chottu workflow`` — workflow management commands."""
...
def list_workflows() -> None:
    ...
    try:
        from Chottu.workflow.loader import discover_workflows
...
def run(workflow_name: str, input_text: str | None) -> None:
    ...
    try:
        ...
        # Full execution would need a ChottuSystem — just report for now
        console.print(

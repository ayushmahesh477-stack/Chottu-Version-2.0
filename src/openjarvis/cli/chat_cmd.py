"""``Chottu chat`` — interactive multi-turn chat REPL."""
...
def chat(
    ...
    # Resolve engine
    from Chottu.engine import get_engine
    from Chottu.intelligence import register_builtin_models
    ...
    if agent_key and agent_key != "none":
        try:
            import Chottu.agents  # noqa: F401 — trigger registration
    ...
    # Print banner
    console.print(
        f"[green bold]Chottu Chat[/green bold]\n"
    ...
    from Chottu.cli._chat_banner import render_startup_banner
    ...
    from Chottu.cli._chat_notifications import NotificationDispatcher

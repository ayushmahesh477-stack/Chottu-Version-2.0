"""Startup banner — Chottu wordmark + tagline."""

from __future__ import annotations

# "Chottu" rendered in the figlet "standard" font. Stored as plain text
...
def print_banner(quiet: bool = False) -> None:
    """Print the Chottu startup banner. No-op when quiet."""
    if quiet:
        return
    try:

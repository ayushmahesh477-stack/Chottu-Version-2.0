"""``Chottu optimize`` — LLM-driven configuration optimization CLI."""
...
def optimize_run(
    ...
    """Run an optimization loop over Chottu configuration."""
    ...
    if config_path is not None:
        try:
            from Chottu.learning.optimize.config import load_optimize_config
        except ImportError:
    ...
    if data is not None:
        try:
            from Chottu.learning.optimize.config import load_benchmark_specs
    ...
    try:
        ...
        from Chottu.learning.optimize.config import load_objectives
        ...
        try:
            from Chottu.evals.cli import _build_judge_backend
...
def skills(policy: str, min_traces: int, dry_run: bool) -> None:
    ...
    from Chottu.learning.agents.skill_optimizer import SkillOptimizer

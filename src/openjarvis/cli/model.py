"""``Chottu model`` — model management subcommands."""
...
from Chottu.core.registry import ModelRegistry
from Chottu.engine import discover_engines, discover_models
from Chottu.intelligence import merge_discovered_models, register_builtin_models

"""Global logging configuration for the Chottu CLI."""
...
from Chottu.security.credential_stripper import CredentialStripper
...
def setup_logging(
    ...
    Returns
    -------
    The configured ``Chottu`` logger.
    """
    logger = logging.getLogger("Chottu")

"""``Chottu host`` — download and serve a model locally with auto backend setup."""
...
def host(
    ...
    \b
      Chottu host mlx-community/Qwen2.5-7B-4bit --backend mlx
      Chottu host Qwen/Qwen3-8B --backend vllm
      Chottu host qwen3:8b --backend ollama
      Chottu host meta-llama/Llama-3-8B -b sglang
    """
    console = Console()
    ...
    if backend != "ollama":
        ...
        console.print(
            "[dim]Chottu will auto-discover it. Press Ctrl+C to stop.[/dim]\n"
        )

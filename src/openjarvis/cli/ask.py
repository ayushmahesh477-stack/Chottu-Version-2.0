"""``Chottu ask`` — send a query to the assistant."""
...
from Chottu.cli._banner import print_banner
from Chottu.cli._tool_names import resolve_tool_names
from Chottu.cli.hints import hint_no_engine
...
from Chottu.engine import (
    EngineConnectionError,
    discover_engines,
    discover_models,
    get_engine,
)
from Chottu.intelligence import (
...
def _run_research(
    *,
    ...
    from Chottu.agents.research_loop import DEFAULT_PLANNER_MODEL, ResearchAgent
    from Chottu.connectors.embeddings import OllamaEmbedder
    from Chottu.connectors.hybrid_search import HybridSearch
    ...
    # (so ``Chottu ask --research "..." > out.md`` still gives a clean
...
def ask(
    ...
    # the most common command (`Chottu ask "..."`).
    ...
    if resolved is None:
        console.print(
            ...
            "  [cyan]Chottu config set engine.ollama.host http://<remote-ip>:11434[/cyan]\n"

...
def create_energy_monitor(
    ...
    try:
        from Chottu.telemetry.energy_nvidia import NvidiaEnergyMonitor
    ...
    try:
        from Chottu.telemetry.energy_amd import AmdEnergyMonitor
    ...
    try:
        from Chottu.telemetry.energy_apple import AppleEnergyMonitor
    ...
    try:
        from Chottu.telemetry.energy_rapl import RaplEnergyMonitor

...
from Chottu.agents._stubs import AgentContext, BaseAgent
from Chottu.core.events import Event, EventBus, EventType
    ...
    async def stream(self) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            try:
                ...
                logger = logging.getLogger("Chottu.server")
            ...
            if engine is not None and hasattr(engine, "stream_full") and content:
                ...
                try:
                    from Chottu.core.types import Message as MsgType
                    from Chottu.core.types import Role as RoleType
                    ...
                    _logger = _logging.getLogger("Chottu.server")
                    _logger.warning(

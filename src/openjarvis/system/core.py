"""ChottuSystem — the fully wired system dataclass."""
...
if TYPE_CHECKING:
    ...
    from Chottu.channels._stubs import BaseChannel
    from Chottu.learning._stubs import RouterPolicy
    ...
    from Chottu.security.boundary import BoundaryGuard
    ...
    from Chottu.speech._stubs import SpeechBackend
...
class ChottuSystem:
    ...
    def wire_channel(self, channel_bridge: Any) -> None:
        ...
        ----------
        channel_bridge:
            A connected :class:`~Chottu.channels._stubs.BaseChannel`
            instance whose ``on_message`` method accepts a callable.
        """
        from Chottu.core.types import Message
        from Chottu.sessions.session import SessionStore
    ...
    def __enter__(self) -> ChottuSystem:
        return self

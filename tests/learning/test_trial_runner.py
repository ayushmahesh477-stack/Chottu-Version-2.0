"""Tests for Chottu.optimize.trial_runner module."""

from __future__ import annotations

from unittest.mock import MagicMock, patch

from Chottu.evals.core.types import RunConfig, RunSummary
from Chottu.learning.optimize.trial_runner import TrialRunner
from Chottu.learning.optimize.types import TrialConfig, TrialResult
...
class TestBuildRunConfig:
    ...
    def test_agent_maps_to_agent_backend(self) -> None:
        ...
        assert cfg.backend == "Chottu-agent"
    ...
    def test_no_agent_maps_to_direct_backend(self) -> None:
        ...
        assert cfg.backend == "Chottu-direct"
...
class TestRunTrial:
    ...
    @patch("Chottu.evals.cli._build_scorer")
    @patch("Chottu.evals.cli._build_judge_backend")
    @patch("Chottu.evals.cli._build_dataset")
    @patch("Chottu.evals.cli._build_backend")
    @patch("Chottu.evals.core.runner.EvalRunner")
    ...
    def test_run_trial_populates_sample_scores(
        ...
        from Chottu.evals.core.types import EvalResult

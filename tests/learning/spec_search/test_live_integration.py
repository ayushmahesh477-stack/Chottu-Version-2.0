...
- TraceStore at ~/.Chottu/traces.db with some traces
"""
...
def real_trace_store():
    ...
    db_path = Path.home() / ".Chottu" / "traces.db"
    if not db_path.exists():
        pytest.skip("No traces.db found at ~/.Chottu/")
...
class TestTeacherAgentLive:
    ...
    def test_teacher_agent_single_turn(self, cloud_engine) -> None:
        from Chottu.learning.spec_search.diagnose.teacher_agent import (
            TeacherAgent,
        )
...
class TestDiagnosisRunnerLive:
    ...
    def test_diagnosis_produces_output(
        ...
        from Chottu.learning.spec_search.diagnose.runner import (
            DiagnosisRunner,
        )
...
class TestColdStartLive:
    ...
    def test_orchestrator_cold_start_with_no_feedback(
        ...
        from Chottu.learning.spec_search.gate.cold_start import (

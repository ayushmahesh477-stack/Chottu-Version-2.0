"""Tests for Chottu.learning.spec_search.execute.base module."""
...
class TestApplyContext:
    ...
    def test_constructs(self, tmp_path: Path) -> None:
        ...
        ctx = ApplyContext(Chottu_home=tmp_path, session_id="s1")
        assert ctx.Chottu_home == tmp_path
...
class TestValidationResult:
    ...
    def test_ok_result(self) -> None:
        from Chottu.learning.spec_search.execute.base import ValidationResult
...
class TestEditApplierRegistry:
    ...
    def test_register_and_get(self) -> None:
        from Chottu.learning.spec_search.execute.base import (
            ApplyContext,
            ApplyResult,
            EditApplier,
            EditApplierRegistry,
        ...
        from Chottu.learning.spec_search.models import Edit, EditOp

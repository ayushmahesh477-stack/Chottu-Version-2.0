...
class TestGRPOConfig:
    def test_default_config(self) -> None:
        from Chottu.core.config import GRPOConfig
...
class TestDefaultRewardFn:
    def test_score_returns_float(self) -> None:
        from Chottu.learning.intelligence.grpo_trainer import DefaultRewardFn
...
class TestGRPOTrainer:
    def test_init(self) -> None:
        from Chottu.core.config import GRPOConfig
        from Chottu.learning.intelligence.grpo_trainer import GRPOTrainer

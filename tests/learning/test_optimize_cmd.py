"""Smoke tests for ``Chottu optimize`` and ``Chottu feedback`` CLI commands,
...
class TestOptimizeConfig:
    """Tests for OptimizeConfig in ChottuConfig."""

    def test_optimize_config_in_Chottu_config(self):
        from Chottu.core.config import ChottuConfig, OptimizeConfig
    ...
    def test_optimize_config_defaults(self):
        from Chottu.core.config import OptimizeConfig

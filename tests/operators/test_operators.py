...
class TestOperativeAgent:
    def test_init_defaults(self):
        ...
        engine = FakeEngine()
        with patch(
            "Chottu.agents._stubs.load_config",
...
class TestSystemAskPassthrough:
    def test_system_prompt_forwarded(self):
        ...
        from Chottu.system import QueryOrchestrator

        with patch.object(QueryOrchestrator, "_run_agent", patched_run_agent):
            real_system = ChottuSystem(
...
class TestOperatorsConfig:
    def test_config_defaults(self):
        from Chottu.core.config import OperatorsConfig
    ...
    def test_config_in_Chottu_config(self):
        from Chottu.core.config import ChottuConfig
...
class TestLoadBundledOperators:
    ...
    def operators_dir(self):
        ...
        ops_dir = project_root / "src" / "Chottu" / "operators" / "data"

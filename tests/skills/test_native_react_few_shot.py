...
from Chottu.agents.native_react import REACT_SYSTEM_PROMPT, NativeReActAgent
...
class TestSystemBuilderCapturesFewShot:
    def test_skill_manager_examples_stored_on_system(self, tmp_path):
        ...
        stashes them on the ChottuSystem instance for _run_agent to
...
class TestRunAgentForwardsExamples:
    def test_run_agent_passes_examples_to_tool_using_agent(self):
        ...
        # Build a minimal ChottuSystem with the captured examples
        system = ChottuSystem.__new__(ChottuSystem)
        ...
        with patch(
            "Chottu.core.registry.AgentRegistry.get",

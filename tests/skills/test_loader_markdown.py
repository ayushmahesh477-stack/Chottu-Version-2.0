...
from Chottu.skills.loader import load_skill_directory, load_skill_markdown
...
class TestParserDelegation:
    def test_load_skill_markdown_uses_parser_for_validation(self, tmp_path: Path):
        ...
        from Chottu.skills.loader import load_skill_markdown
...
class TestLoadSkillDirectorySourcePromotion:
    def test_dot_source_file_promoted_to_metadata(self, tmp_path: Path):
        ...
        into manifest.metadata.Chottu.source."""
    ...
    def test_no_dot_source_file_no_metadata(self, tmp_path: Path):
        """When no .source file is present, metadata.Chottu.source is unset."""
        from Chottu.skills.loader import load_skill_directory

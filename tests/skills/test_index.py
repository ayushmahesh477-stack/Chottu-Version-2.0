...
from Chottu.skills.index import SkillIndex
...
class TestSkillIndex:
    def test_load_index(self, tmp_path: Path):
        ...
        index_file.write_text(
            ...
            author = "Chottu"
            source = "github.com/Chottu/skills/research"
            sha256 = "abc123"
            tags = ["research"]
    ...
    def test_search_by_name(self, tmp_path: Path):
        ...
        index_file.write_text(
            ...
            author = "Chottu"
            source = "github.com/Chottu/skills/web_research"
            sha256 = "abc"
            tags = ["research"]
            required_capabilities = []
            ...
            author = "Chottu"
            source = "github.com/Chottu/skills/code_review"
            sha256 = "def"
            tags = ["coding"]
            required_capabilities = []
        """)

...
from Chottu.core import get_python_executable
from Chottu.tools.shell_exec import ShellExecTool
...
class TestShellExecTool:
    def test_registered_via_tools_package_import(self):
        import Chottu.tools as tools_pkg
        from Chottu.core.registry import ToolRegistry

        sys.modules.pop("Chottu.tools.shell_exec", None)
    ...
    def test_env_clearing(self):
        ...
        marker = "Chottu_TEST_SECRET_12345"
    ...
    def test_env_passthrough(self):
        ...
        marker = "Chottu_TEST_PASSTHROUGH_67890"

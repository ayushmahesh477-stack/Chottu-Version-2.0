...
class TestGetRustModule:
    ...
    def test_returns_rust_module(self):
        """get_rust_module() returns the Chottu_rust module."""
        from Chottu._rust_bridge import get_rust_module

        get_rust_module.cache_clear()
        result = get_rust_module()
        assert result is not None
        assert hasattr(result, "__name__")
        assert result.__name__ == "Chottu_rust"
...
class TestScanResultFromJson:
    ...
    def test_empty_findings(self):
        from Chottu._rust_bridge import scan_result_from_json
...
class TestInjectionResultFromJson:
    ...
    def test_clean(self):
        from Chottu._rust_bridge import injection_result_from_json
...
class TestRetrievalResultsFromJson:
    ...
    def test_empty(self):
        from Chottu._rust_bridge import retrieval_results_from_json
...
class TestRustBackedModules:
    ...
    def test_injection_scanner_uses_rust(self):
        ...
        from Chottu.security.injection_scanner import InjectionScanner
    ...
    def test_rate_limiter_uses_rust(self):
        ...
        from Chottu.security.rate_limiter import RateLimiter

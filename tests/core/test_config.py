...
class TestDefaults:
    def test_Chottu_config_defaults(self) -> None:
        cfg = ChottuConfig()
...
class TestTomlLoading:
    def test_load_missing_file_uses_defaults(self, tmp_path: Path) -> None:
        ...
        assert isinstance(cfg, ChottuConfig)
...
class TestSecurityConfig:
    ...
    def test_security_config_on_Chottu_config(self) -> None:
        cfg = ChottuConfig()
...
class TestChannelConfig:
    ...
    def test_channel_config_on_Chottu_config(self) -> None:
        cfg = ChottuConfig()
...
class TestSandboxConfig:
    def test_defaults(self) -> None:
        ...
        assert sc.image == "Chottu-sandbox:latest"
    ...
    def test_on_Chottu_config(self) -> None:
        cfg = ChottuConfig()
...
class TestApplyTomlSectionListNormalization:
    def test_apply_toml_section_list_to_str_field(self) -> None:
        ...
        from Chottu.core.config import ToolsConfig, _apply_toml_section
    ...
    def test_apply_toml_section_list_to_property_setter(self) -> None:
        ...
        from Chottu.core.config import _apply_toml_section
...
class TestWhatsAppBaileysChannelConfig:
    def test_defaults(self) -> None:
        ...
        assert wc.auth_dir == ""
        assert wc.assistant_name == "Chottu"

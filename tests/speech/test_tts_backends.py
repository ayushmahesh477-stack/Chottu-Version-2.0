...
from Chottu.core.registry import TTSRegistry
from Chottu.speech.tts import TTSResult
...
def test_cartesia_registered():
    from Chottu.speech.cartesia_tts import CartesiaTTSBackend
...
def test_cartesia_synthesize():
    ...
    with patch(
        "Chottu.speech.cartesia_tts._cartesia_synthesize",
...
def test_kokoro_registered():
    from Chottu.speech.kokoro_tts import KokoroTTSBackend
...
def test_openai_tts_registered():
    from Chottu.speech.openai_tts import OpenAITTSBackend
...
def test_openai_tts_synthesize():
    ...
    with patch(
        "Chottu.speech.openai_tts._openai_tts_request",

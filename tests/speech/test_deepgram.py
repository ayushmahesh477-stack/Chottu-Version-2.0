...
from Chottu.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_transcribe():
    ...
    with patch("Chottu.speech.deepgram.DeepgramClient", return_value=mock_client):
        from Chottu.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_health():
    with patch("Chottu.speech.deepgram.DeepgramClient"):
        from Chottu.speech.deepgram import DeepgramSpeechBackend

...
from Chottu.speech.faster_whisper import FasterWhisperBackend
...
def test_faster_whisper_transcribe():
    ...
    with patch(
        "Chottu.speech.faster_whisper.WhisperModel",
...
def test_faster_whisper_supported_formats():
    ...
    with patch("Chottu.speech.faster_whisper.WhisperModel"):
        from Chottu.speech.faster_whisper import FasterWhisperBackend

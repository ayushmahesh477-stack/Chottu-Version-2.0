...
from Chottu.core.registry import SpeechRegistry
from Chottu.speech._stubs import TranscriptionResult
from Chottu.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_transcribe():
    ...
    with patch("Chottu.speech.openai_whisper.OpenAI", return_value=mock_client):
        from Chottu.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_health():
    with patch("Chottu.speech.openai_whisper.OpenAI"):
        from Chottu.speech.openai_whisper import OpenAIWhisperBackend

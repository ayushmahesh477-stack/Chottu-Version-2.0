"""Tests for the ``Chottu registry`` CLI commands."""
...
class TestRegistryCmd:
    """Test cases for the Chottu registry CLI group."""
    ...
    def test_registry_show_handles_exception(self) -> None:
        ...
        with patch(
            "Chottu.core.registry.ToolRegistry.keys",
    ...
    def test_registry_show_handles_error_during_import(self) -> None:
        ...
        with patch.dict("sys.modules", {"Chottu.core.registry": None}):

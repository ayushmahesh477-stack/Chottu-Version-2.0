"""Tests for ``Chottu doctor`` optional dependency labels."""
...
class TestDoctorOptionalLabels:
    ...
    def test_labels_show_install_hint_on_missing(self) -> None:
        ...
        assert "Not installed (Chottu[energy-apple])" == apple_checks[0]["message"]
    ...
    def test_nvidia_label_uses_current_extra_name(self) -> None:
        ...
        assert "Not installed (Chottu[gpu-metrics])" == nvidia_checks[0]["message"]

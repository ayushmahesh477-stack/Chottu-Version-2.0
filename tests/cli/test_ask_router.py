"""Tests for model resolution fallback chain in Chottu ask."""
...
def _register_agents():
    ...
    The default ``ChottuConfig().agent.default_agent`` is ``"simple"``,
    so ``Chottu ask "..."`` (without ``--agent``) routes through SimpleAgent.

"""Tests for Chottu optimize skills CLI command (Plan 2A)."""
...
class TestOptimizeSkillsCommand:
    ...
    def test_dry_run_no_traces(self, tmp_path: Path) -> None:
        ...
        with patch(
            "Chottu.cli.optimize_cmd._get_trace_store",
    ...
    def test_optimize_runs_with_mocked_optimizer(self, tmp_path: Path) -> None:
        ...
        from Chottu.learning.agents.skill_optimizer import (
        ...
        with patch(
            ...
            with patch(
                "Chottu.learning.agents.skill_optimizer.SkillOptimizer.optimize",

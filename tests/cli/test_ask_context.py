"""Tests for context injection integration in ``Chottu ask``."""
...
def test_get_memory_backend_returns_backend_even_when_empty(
    ...
    failures downstream.
    """
    from Chottu.core.config import ChottuConfig, MemoryConfig
    ...
    mod = importlib.import_module("Chottu.cli.ask")

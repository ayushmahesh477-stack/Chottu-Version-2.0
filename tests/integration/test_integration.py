...
from Chottu.core.registry import AgentRegistry, RouterPolicyRegistry, ToolRegistry
...
class TestAPIServerRoundtrip:
    ...
    def test_roundtrip(self):
        ...
        from Chottu.server.app import create_app
...
class TestToolExecutorIntegration:
    ...
    def test_calculator_and_think(self):
        _register_tools()
        from Chottu.tools._stubs import ToolExecutor
        from Chottu.tools.calculator import CalculatorTool
        from Chottu.tools.think import ThinkTool
...
class TestHeuristicRewardWithTelemetry:
    ...
    def test_reward_from_telemetry_record(self):
        from Chottu.learning._stubs import RoutingContext
...
class TestRouterPolicyRegistryDiscovery:
    ...
    def test_both_policies_registered(self):
        from Chottu.learning import ensure_registered
...
class TestAskFlowWithRouterPolicy:
    ...
    def test_mocked_ask_with_registry_router(self):
        from Chottu.learning._stubs import RoutingContext
        from Chottu.learning.routing.heuristic_policy import ensure_registered
...
class TestSDKImport:
    """Verify Chottu class is importable from Chottu."""

    def test_Chottu_imports(self):
        from Chottu import Chottu

        assert Chottu is not None
...
class TestSDKAskFlow:
    ...
    def test_sdk_ask_e2e(self):
        ...
        from Chottu.sdk import Chottu

        engine = _make_engine("SDK response")
        with patch("Chottu.sdk.get_engine", return_value=("mock", engine)):
            j = Chottu(config=ChottuConfig(), model="test-model")
...
class TestSDKMemoryHandle:
    ...
    def test_index_and_search(self, tmp_path):
        from Chottu.core.config import ChottuConfig
        from Chottu.sdk import MemoryHandle
...
class TestBenchmarkRegistryDiscovery:
    ...
    def test_discovers_benchmarks(self):
        from Chottu.bench import ensure_registered
...
class TestBenchmarkSuiteRunAll:
    ...
    def test_suite_produces_jsonl(self):
        ...
        from Chottu.bench import ensure_registered
        from Chottu.bench._stubs import BenchmarkSuite
        from Chottu.core.registry import BenchmarkRegistry
...
class TestFullPipeline:
    ...
    def test_full_pipeline(self, tmp_path):
        ...
        from Chottu.agents._stubs import AgentResult
        from Chottu.core.config import ChottuConfig
        ...
        with patch("Chottu.sdk.get_engine", return_value=("mock", engine)):
            j = Chottu(config=cfg, model="test-model")

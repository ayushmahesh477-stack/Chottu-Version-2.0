...
class TestOpenHandsPipeline:
    ...
    def test_openhands_code_execution_e2e(self):
        _register_all()
        from Chottu.agents.native_openhands import NativeOpenHandsAgent
        from Chottu.tools.code_interpreter import (
            CodeInterpreterTool,
        )
...
class TestMCPIntegration:
    ...
    def test_mcp_server_with_all_tools(self):
        ...
        from Chottu.mcp.transport import InProcessTransport
        from Chottu.tools.calculator import CalculatorTool
        from Chottu.tools.think import ThinkTool
    ...
    def test_mcp_unknown_tool_error(self):
        from Chottu.mcp.client import MCPClient
        from Chottu.mcp.protocol import MCPError
        from Chottu.mcp.server import MCPServer
        from Chottu.mcp.transport import InProcessTransport
        from Chottu.tools.calculator import CalculatorTool
...
class TestModelCatalogIntegration:
    ...
    def test_all_models_routable(self):
        ...
        from Chottu.intelligence.model_catalog import (
            BUILTIN_MODELS,
        )

...
from Chottu.agents.channel_agent import ChannelAgent
...
def test_quick_query_inline_response(tmp_path: Path) -> None:
    ...
    containing calendar info and NO Chottu:// link.
    """
    ...
    assert "Chottu://" not in sent_content, (

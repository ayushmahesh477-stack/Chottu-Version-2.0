...
from Chottu.core.types import Conversation, Message, Role, ToolCall, ToolResult
...
class TestBuildMessages:
    ...
    def test_empty_config_default_no_system_message(self, monkeypatch):
        ...
        empty_cfg = ChottuConfig()
        empty_cfg.agent.default_system_prompt = ""
        monkeypatch.setattr("Chottu.agents._stubs.load_config", lambda: empty_cfg)

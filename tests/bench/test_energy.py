...
from Chottu.bench.energy import EnergyBenchmark
from Chottu.core.registry import BenchmarkRegistry
from Chottu.telemetry.energy_monitor import EnergySample


@pytest.fixture(autouse=True)
def _register_energy():
    """Re-register energy benchmark after registry clear."""
    from Chottu.bench.energy import ensure_registered

...
class TestDetectHardware:
    ...
    @patch("Chottu.core.config.shutil.which", return_value="/usr/bin/nvidia-smi")
    @patch(
        "Chottu.core.config._run_cmd",
    ...
    @patch("Chottu.core.config.shutil.which", return_value="/usr/bin/rocm-smi")
    @patch(
        "Chottu.core.config._run_cmd",
        side_effect=[
    ...
    @patch("Chottu.core.config.platform.system", return_value="Darwin")
    @patch(
        "Chottu.core.config._run_cmd",
        return_value=(
            "Graphics/Displays:\n"
    ...
    @patch("Chottu.core.config.shutil.which", return_value=None)
    @patch("Chottu.core.config.platform.system", return_value="Linux")

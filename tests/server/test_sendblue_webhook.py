...
pytest.importorskip("fastapi", reason="Chottu[server] not installed")

from fastapi import FastAPI  # noqa: E402
from starlette.testclient import TestClient  # noqa: E402

from Chottu.core.registry import ChannelRegistry  # noqa: E402
...
def webhook_app(mock_bridge, sendblue_channel):
    from Chottu.server.webhook_routes import create_webhook_router

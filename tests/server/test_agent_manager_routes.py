...
class TestAgentManagerRoutes:
    ...
    def client(self, manager):
        ...
        from Chottu.server.agent_manager_routes import create_agent_manager_router
...
class TestAgentManagerStreaming:
    ...
    def _mock_engine(self):
        ...
        from Chottu.engine._stubs import StreamChunk
...
class TestResolveToolSpecs:
    ...
    def test_string_names_resolve_to_openai_specs(self, _registered_tools):
        from Chottu.server.agent_manager_routes import _resolve_tool_specs

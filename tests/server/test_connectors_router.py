...
def test_connect_slack_bot_token_returns_400(app, tmp_path: Path) -> None:
    ...
    from Chottu.server.connectors_router import _instances
...
def test_connect_granola_invalid_key_returns_400_keeps_existing(
    ...
    from Chottu.connectors.granola import GranolaConnector, GranolaKeyError
    from Chottu.server.connectors_router import _instances
    ...
    try:
        with patch(
            "Chottu.connectors.granola._granola_api_validate_key",

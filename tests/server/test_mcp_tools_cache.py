...
def test_returns_tools_from_mcp_server(mock_load_config: MagicMock):
    ...
    with (
        patch("Chottu.mcp.transport.StreamableHTTPTransport"),
        patch("Chottu.mcp.client.MCPClient"),
        patch("Chottu.tools.mcp_adapter.MCPToolProvider") as MockProvider,
    ):

...
from Chottu.core.types import Role  # noqa: E402
from Chottu.server.agent_manager_routes import (  # noqa: E402
...
class TestBuildManagedSystemPrompt:
    ...
    def _config_with_soul(self, tmp_path):
        ...
        soul.write_text("You are Chottu, a meticulous local-first assistant.")
    ...
    def test_matches_cli_builder_output(self, tmp_path):
        ...
        so streaming chat and `Chottu ask` assemble the prompt identically.
        """
        from Chottu.core.config import MemoryFilesConfig, SystemPromptConfig

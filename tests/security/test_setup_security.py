...
from Chottu.core.config import CapabilitiesConfig, ChottuConfig, SecurityConfig
from Chottu.core.events import EventBus
from Chottu.security import SecurityContext, setup_security
...
def _make_config(*, enabled: bool = True, caps_enabled: bool = False) -> ChottuConfig:
    cfg = ChottuConfig()

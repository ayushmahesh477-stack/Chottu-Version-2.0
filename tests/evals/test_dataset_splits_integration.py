...
PROVIDERS = [
    ("Chottu.evals.datasets.pinchbench", "PinchBenchDataset"),
    ("Chottu.evals.datasets.liveresearch", "LiveResearchBenchDataset"),
    ("Chottu.evals.datasets.gaia", "GAIADataset"),
    ("Chottu.evals.datasets.liveresearchbench", "LiveResearchBenchDataset"),
    ("Chottu.evals.datasets.taubench", "TauBenchDataset"),
    ("Chottu.evals.datasets.toolcall15", "ToolCall15Dataset"),
    ("Chottu.evals.datasets.livecodebench", "LiveCodeBenchDataset"),
]

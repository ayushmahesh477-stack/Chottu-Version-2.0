...
from Chottu.evals.core.event_recorder import AgentEvent, EventType
from Chottu.evals.core.trace import TurnTrace
...
def test_events_to_transcript_tool_call_pair():
    ...
    from Chottu.evals.scorers.pinchbench import events_to_transcript
...
def test_events_to_transcript_tool_name_mapping():
    """Chottu tool names are mapped to PinchBench-expected names."""
    from Chottu.evals.scorers.pinchbench import events_to_transcript

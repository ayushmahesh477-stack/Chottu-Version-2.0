...
- ChottuDirectBackend propagates gpu_metrics flag
...
from Chottu.evals.core.types import EvalResult, RunConfig, RunSummary
...
class TestSummaryToDict:
    ...
    def test_telemetry_summary_present(self):
        from Chottu.evals.core.runner import _summary_to_dict
...
class TestResultToTraceDict:
    ...
    def test_estimated_flops_in_trace(self):
        from Chottu.evals.core.runner import _result_to_trace_dict
...
# ---------------------------------------------------------------------------
# ChottuDirectBackend gpu_metrics propagation
# ---------------------------------------------------------------------------


class TestDirectBackendGpuMetrics:
    """Verify ChottuDirectBackend sets gpu_metrics on config."""

    @patch("Chottu.system.SystemBuilder")
...
class TestTauBenchTelemetryPassthrough:
    ...
    @patch("Chottu.evals.execution.taubench_env.TauBenchTaskEnv")
...
class TestExpandSuiteModelMetadata:
    ...
    def test_metadata_includes_params(self):
        from Chottu.evals.core.config import expand_suite
        from Chottu.evals.core.types import (
            BenchmarkConfig,
            DefaultsConfig,
            EvalSuiteConfig,
            ExecutionConfig,

"""Verify ChottuAgentBackend.generate_full returns the spec §6.2 extended fields."""
...
class TestChottuAgentExtendedFields:
    def test_generate_full_includes_framework_and_commit(self) -> None:
        ...
        with patch("Chottu.system.SystemBuilder") as MockSB:
            ...
            backend = ChottuAgentBackend(model="qwen-9b")

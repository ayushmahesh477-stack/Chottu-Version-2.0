"""Tests for ChottuAgentBackend skills_enabled / overlay_dir kwargs (Plan 2B)."""
...
class TestChottuAgentBackendSkillsKwargs:
    ...
    def test_init_signature_accepts_kwargs_without_engine(self):
        ...
        sig = inspect.signature(ChottuAgentBackend.__init__)

...
PROVIDERS = [
    ("Chottu.evals.datasets.adp", "ADPDataset"),
    ("Chottu.evals.datasets.toolorchestra", "ToolOrchestraDataset"),
    ("Chottu.evals.datasets.generalthoughts", "GeneralThoughtsDataset"),
]

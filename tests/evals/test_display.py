"""Tests for the Rich display helpers in Chottu.evals.core.display."""
...
from Chottu.evals.core.types import MetricStats, RunSummary
...
class TestPrintBanner:
    def test_produces_output(self):
        ...
        output = buf.getvalue()
        assert "Chottu" in output or "___" in output

"""Tests for Chottu.evals.backends.external._subprocess_runner."""
...
from Chottu.evals.backends.external._subprocess_runner import (
    EnergySample,
    SubprocessResult,
    run_one_shot,
)
...
class TestEnergySampler:
    def test_fallback_chain_reaches_unavailable(
        ...
        from Chottu.evals.backends.external import _subprocess_runner as m

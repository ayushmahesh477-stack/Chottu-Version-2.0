...
from Chottu.evals.cli import BACKENDS, _build_backend
...
class TestBuildBackendDispatch:
    def test_backends_dict_includes_external(self) -> None:
        ...
        assert "Chottu-agent" in BACKENDS
        assert "Chottu-direct" in BACKENDS
    ...
    def test_hermes_returns_hermes_backend(self) -> None:
        ...
        with (
            ...
            patch("Chottu.evals.backends.external.hermes_agent.verify_commit_pin"),
        ):

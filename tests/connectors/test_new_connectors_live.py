...
class TestOuraLive:
    def test_sync_returns_documents(self):
        from Chottu.connectors.oura import OuraConnector
...
class TestStravaLive:
    def test_sync_returns_documents(self):
        from Chottu.connectors.strava import StravaConnector
...
class TestSpotifyLive:
    def test_sync_returns_documents(self):
        from Chottu.connectors.spotify import SpotifyConnector
...
class TestGoogleTasksLive:
    def test_sync_returns_documents(self):
        from Chottu.connectors.google_tasks import GoogleTasksConnector

...
def connector(tmp_path: Path):
    ...
    from Chottu.connectors.gcalendar import GCalendarConnector  # noqa: PLC0415

    creds_path = str(tmp_path / "gcalendar.json")
    with patch(
        "Chottu.connectors.oauth._SHARED_GOOGLE_CREDENTIALS_PATH",
...
@patch("Chottu.connectors.gcalendar._gcal_api_calendars_list")
@patch("Chottu.connectors.gcalendar._gcal_api_events_list")

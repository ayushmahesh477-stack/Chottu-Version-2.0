...
def connector(tmp_path: Path):
    ...
    from Chottu.connectors.dropbox import DropboxConnector  # noqa: PLC0415
...
@patch("Chottu.connectors.dropbox._dropbox_api_list_folder")
@patch("Chottu.connectors.dropbox._dropbox_api_download")

...
def connector(tmp_path: Path):
    ...
    from Chottu.connectors.gdrive import GDriveConnector  # noqa: PLC0415
...
@patch("Chottu.connectors.gdrive._gdrive_api_list_files")
@patch("Chottu.connectors.gdrive._gdrive_api_export")

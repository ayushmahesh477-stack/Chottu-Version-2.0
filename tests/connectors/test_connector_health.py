...
_LOCAL_CONNECTORS = [
    ("apple_notes", "Chottu.connectors.apple_notes", "AppleNotesConnector"),
    ("imessage", "Chottu.connectors.imessage", "IMessageConnector"),
]

_TOKEN_CONNECTORS = [
    ("gmail_imap", "Chottu.connectors.gmail_imap", "GmailIMAPConnector"),
    ("outlook", "Chottu.connectors.outlook", "OutlookConnector"),
    ("slack", "Chottu.connectors.slack_connector", "SlackConnector"),
    ("notion", "Chottu.connectors.notion", "NotionConnector"),
    ("granola", "Chottu.connectors.granola", "GranolaConnector"),
    ("gdrive", "Chottu.connectors.gdrive", "GDriveConnector"),
    ("gcalendar", "Chottu.connectors.gcalendar", "GCalendarConnector"),
    ("gcontacts", "Chottu.connectors.gcontacts", "GContactsConnector"),
    ("dropbox", "Chottu.connectors.dropbox", "DropboxConnector"),
]

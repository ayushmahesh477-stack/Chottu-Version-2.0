...
def connector(tmp_path: Path):
    ...
    from Chottu.connectors.notion import NotionConnector  # noqa: PLC0415
...
@patch("Chottu.connectors.notion._notion_api_search")
@patch("Chottu.connectors.notion._notion_api_get_blocks")
...
def test_render_blocks_to_markdown() -> None:
    ...
    from Chottu.connectors.notion import _render_blocks_to_markdown  # noqa: PLC0415

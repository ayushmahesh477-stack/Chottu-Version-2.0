...
from Chottu.mcp.protocol import MCPRequest
...
class TestServerTitle:
    def test_initialize_includes_title(self, server):
        ...
        assert server_info["title"] == "Chottu Tool Server"
...
class TestStorageToolAnnotations:
    def test_memory_store_destructive(self):
        from Chottu.tools.storage_tools import MemoryStoreTool
    ...
    def test_memory_retrieve_read_only(self):
        from Chottu.tools.storage_tools import MemoryRetrieveTool

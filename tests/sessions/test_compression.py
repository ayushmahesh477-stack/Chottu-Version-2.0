...
from Chottu.core.registry import CompressionRegistry
...
def _register_compressors():
    ...
    from Chottu.sessions.compression import (
        ModelSummarization,
...
def test_rule_based_strips_tool_boilerplate():
    from Chottu.sessions.compression import RuleBasedPrecompression
...
def test_session_consolidation_preserves_recent():
    from Chottu.sessions.compression import SessionConsolidation
...
def test_tiered_summaries_gradient():
    from Chottu.sessions.compression import TieredSummaries
